...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Service Menus</h1>
   
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a type="button"  data-toggle="modal" data-target="#addProduct" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> New Service</a>
        </div>
    <!-- DataTales Example -->
            ...
            <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <tbody>
                        ...
                        <tr class="odd">
                            <td class="sorting_1">
                            <img style=" max-width: 30px; " src="{{asset(str_replace('public','storage',$service->icon))}}" alt="" srcset="">
                            </td>
                            <td>{{$service->name}}</td>
                            ...
                            <td>
                                {{-- <a  href="{{route('admin.service_post',$service->id)}}" type="button"  class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View</a> --}}
    ...
    @include('dashboard.services.service_post')
